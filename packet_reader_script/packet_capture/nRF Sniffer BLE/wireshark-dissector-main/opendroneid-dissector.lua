...
odid_loc_lat = ProtoField.int32("OpenDroneID.loc_lat", "UA Latitude", base.DEC)
...
odid_system_lat = ProtoField.int32("OpenDroneID.system_lat","Operator Latitude",base.DEC)
